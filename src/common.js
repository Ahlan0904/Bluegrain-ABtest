...
export function initializeCommonUI() {
  ...
  if (mypageBtn && mypageModal && mypageClose) {
    mypageBtn.addEventListener('click', (e) => { e.preventDefault(); mypageModal.style.display = 'flex'; });
    mypageClose.addEventListener('click', () => { mypageModal.style.display = 'none'; });
